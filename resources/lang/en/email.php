...
return [
    ...
    'register-footer'     => 'If the button above does not work, copy and paste the URL into your browsers address bar. If you have any trouble signing up or using the site, please visit docs.riff.cc in any web browser.',
