            ...
            <div class="header aboutus">
                <div class="aboutus_content">
                    <div class="content">
                        ...
                        <img src="{{ url('img/deadpool.png') }}" alt="deadpool" width="100%" height="298">
                        ...
                        <h4><i class="{{ config('other.font-awesome') }} fa-globe" aria-hidden="true"></i>
                            @lang('page.aboutus-advantage') {{ config('other.title') }}
                        ...
                        <div class="wrapper">
                            ...
                            <h4><i class="{{ config('other.font-awesome') }} fa-globe" aria-hidden="true"></i>
                                @lang('page.aboutus-rules') <i class="{{ config('other.font-awesome') }} fa-globe"
                        ...
                        <a href="{{ route('contact.index') }}" class="contact button white">@lang('common.contact')
